...
|---|--------|-------------|--------------|-----|------------------------|
| 1 | S1 | 2026-01-15 10:00:00 | `1768471200000` | `0.72` | `2026_01` |
| 2 | S1 | 2026-01-15 10:01:00 | `1768471260000` | `0.75` | `2026_01` |
| 3 | S2 | 2026-01-15 10:00:00 | `1768471200000` | `0.81` | `2026_01` |
| 4 | S2 | 2026-01-15 10:02:00 | `1768471320000` | `0.79` | `2026_01` |
| 5 | S3 | 2026-01-15 10:00:00 | `1768471200000` | `1200` | `2026_01` |
| 6 | S3 | 2026-01-15 10:01:30 | `1768471290000` | `1248` | `2026_01` |
| 7 | S1 | **2026-02-03** 08:00:00 | `1770105600000` | `0.65` | **`2026_02`** |

时间戳列为 **UTC 毫秒**，与「时间（UTC）」列一一对应，可直接用于 `/api/v1/import/prometheus` 或 remote write 调试。
...
| 角色 | 样本 part（`data/small|big/YYYY_MM/`） | IndexDB part（`data/indexdb/YYYY_MM/`） |
|------|----------------------------------------|------------------------------------------|
| 粗索引 | `metaindex.bin` | `metaindex.bin` |
| 细索引 | `index.bin` | `index.bin` |
| payload | `timestamps.bin` + `values.bin` | **`items.bin` + `lens.bin`** |
| 详解 | [第 4 篇 §6.2](./04-part-block-disk.md#62-两层索引metaindex-粗筛--index-精定位) | [IndexDB 专题 §5](./05-indexdb-write-path.md#5-indexdb-part-磁盘布局mergeset-四文件) |
...
| mergeset | `lib/mergeset/` | IndexDB 磁盘 part（items/lens/index/metaindex） |
