...
|---|--------|-------------|--------------|-----|------------------------------|
| 1 | S1 | 2026-01-15 10:00:00 | `1736935200000` | `0.72` | partition `2026_01` |
| 2 | S1 | 2026-01-15 10:01:00 | `1736935260000` | `0.75` | partition `2026_01` |
| 3 | S2 | 2026-01-15 10:00:00 | `1736935200000` | `0.81` | partition `2026_01` |
| 4 | S2 | 2026-01-15 10:02:00 | `1736935320000` | `0.79` | partition `2026_01` |
| 5 | S3 | 2026-01-15 10:00:00 | `1736935200000` | `1200` | partition `2026_01` |
| 6 | S3 | 2026-01-15 10:01:30 | `1736935290000` | `1248` | partition `2026_01` |
| 7 | S1 | 2026-02-03 08:00:00 | `1738569600000` | `0.65` | partition **`2026_02`**（跨月） |
...
├─────────────────────────────────────────────────────────┤
│ Samples:                                                 │
│   {Value: 0.72, Timestamp: 1736935200000}  ← 示例 #1     │
│   {Value: 0.75, Timestamp: 1736935260000}  ← 示例 #2     │
└─────────────────────────────────────────────────────────┘
```
...
|---|------------------------|-----------|-------|
| 1 | `cpu_usage` + host=h1, job=api | 1736935200000 | 0.72 |
| 2 | 同上 | 1736935260000 | 0.75 |
| 3 | `cpu_usage` + host=h2, job=api | 1736935200000 | 0.81 |
| 4 | 同上 | 1736935320000 | 0.79 |
| 5 | `http_requests_total` + host=h1, path=/x | 1736935200000 | 1200 |
| 6 | 同上 | 1736935290000 | 1248 |
| 7 | 同 #1（S1） | 1738569600000 | 0.65 |
